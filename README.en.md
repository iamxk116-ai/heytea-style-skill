...
Each run returns two finished variants by default: one text-integrated poster and one text-free narrative poster. These three typical cases show the complete chain directly on the GitHub home page: source photograph → text-integrated result → text-free result.

| Source · Mixed berries | Text-integrated · “莓好碰头” | Text-free narrative |
| --- | --- | --- |
| ![Mixed berries source photograph](docs/assets/cases/berries/source.webp) | ![Mixed berries text-integrated result](docs/assets/cases/berries/text.webp) | ![Mixed berries text-free result](docs/assets/cases/berries/no-text.webp) |

| Source · Seafood and beef hotpot | Text-integrated · “锅里见” | Text-free narrative |
| --- | --- | --- |
| ![Hotpot source photograph](docs/assets/cases/hotpot/source.webp) | ![Hotpot text-integrated result](docs/assets/cases/hotpot/text.webp) | ![Hotpot text-free result](docs/assets/cases/hotpot/no-text.webp) |

| Source · Orange cat | Text-integrated · “喵两句” | Text-free narrative |
| --- | --- | --- |
| ![Orange cat source photograph](docs/assets/cases/orange-cat/source.webp) | ![Orange cat text-integrated result](docs/assets/cases/orange-cat/text.webp) | ![Orange cat text-free result](docs/assets/cases/orange-cat/no-text.webp) |
